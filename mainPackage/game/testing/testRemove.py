...
class UnitTesting(unittest.TestCase):
    ...
    def testRemove(self):
        with open("testDatabase/testRemoveJson.json") as f:
            originalJson = json.load(f)
        with open("testDatabase/varifyRemove.json") as f:
            expectedJsonStr = json.load(f)
        testName = "shesky17"
        backEnd.removePlayer(testName, "testDatabase/testRemoveJson.json")
        with open("testDatabase/testRemoveJson.json") as f:
            removed = json.load(f)
        ...
        with open("testDatabase/testRemoveJson.json", "w") as f:
