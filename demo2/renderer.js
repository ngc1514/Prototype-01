...
function preload() {
    ...
    game.load.image('bullet', 'https://i.imgur.com/iSgg3AY.png');
    game.load.spritesheet('player', 'https://i.imgur.com/yHXXjup.png', 72, 62, 4); //size 72, 62, 4 fps
    game.load.spritesheet('enemy','https://i.imgur.com/rEa9ALr.png');
    game.load.spritesheet('stone', 'https://i.imgur.com/AFIdBQY.png');
}
